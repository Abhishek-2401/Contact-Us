...
const Branch = () => {
  return (
    <div className="branch-container m-4">
      ...
      <h2 className="text-3xl font-bold ml-24 md:ml-20 mt-8 mb-2">Our Branch</h2>

      <div className="border border-gray-300 ml-4 md:ml-20 mr-4 md:mr-20 mt-8 p-4 rounded-xl flex flex-col md:flex-row w-62 overflow-hidden">
        
        <div className="w-full md:w-1/2 mt-4 px-4">
          <h3 className="text-3xl font-normal mb-2">
            <span className="camplify-h3 font-semibold">Camplify</span> Kerala
          </h3>
          <p className="text-xl-gray-600 mb-4 leading-relaxed">
            campfly private limited <br />
            104, S Janatha Rd, Palarivattom, Kochi, Kerala 682025, India<br />
            Kochi, Kerala 682025 <br />
            India <br />
            Phone: <span className="text-[#161EDD]">(+91) 8891999253 <br />
            info@campfly.in</span>
          </p>
        </div>
